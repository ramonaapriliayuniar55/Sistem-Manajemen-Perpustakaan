...
<div class="card">
    ...
    <div class="info">
        ...
        <p><strong>Dibuat oleh:</strong> Ramona Aprilia Yuniar</p>
    ...
    $alamat_perpus  = "Jl. Citarum No. 31, Kebondalem, Pemalang, Jawa Tengah";
    ...
    <div class="info">
        ...
        <p><strong>Tersedia:</strong> <?php echo $buku_tersedia; ?> buku (<?php echo $persen_tersedia; ?>%)</p>
    </div>
